...
s_node = sub2ind(size(map), start_coords(1), start_coords(2));
d_node  = sub2ind(size(map), dest_coords(1),  dest_coords(2));
...
%
    ...
    if ((current == d_node) || isinf(min_dist))
        break;
    end;
